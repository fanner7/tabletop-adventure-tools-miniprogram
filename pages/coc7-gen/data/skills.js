// pages/coc7-gen/data/skills.js — 静态数据表（由 coc7-gen.js 引入，请勿手改数据）
...
const ALL_SKILLS = [
  ...
  { name: '生存', base: 10, cat: 'investigate' , spec: {"type":"options","defaultBase":10,"options":[{"name":"荒漠","base":10},{"name":"极地","base":10},{"name":"森林","base":10},{"name":"丛林","base":10},{"name":"山地","base":10},{"name":"海洋","base":10}]}  , desc: '· 生存技能提供在野外寻找食物、水源与庇护所，生火以及规避危险的专业知识\n\n· 选择这项技能时，必须明确一种专攻环境（荒漠、极地、森林、丛林、山地或海洋）\n\n· 在不熟悉的极端环境中，KP 可以提高难度等级'  },
...
module.exports = {
  ...
  FREE_SKILL_ALIAS: FREE_SKILL_ALIAS,
  CN_NUM: CN_NUM
};
